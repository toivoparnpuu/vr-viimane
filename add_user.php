    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        if(isset($_POST["user_data_submit"])){
            ...
            if(isset($_POST["password_input"]) and !empty($_POST["password_input"])){
                ...
                $password_error = "Palun sisesta salasõµna!";
            }
            //parooli kordus
            ...
            //kui kأµik kombes, salvestame uue kasutaja
...
<html lang="et">
  ...
  <body>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	  ...
	  <input name="first_name_input" id="first_name_input" type="text" value="<?php echo $first_name; ?>"><span><?php echo $firstname_error; ?></span><br>
